...
export const ProjectTransition: React.FC<any> = ({ color }) => {
  ...
  return (
    <Plane
      position={[0, -2, -3]}
      scale={[canvasWidth, sectionHeight * 2, 1]}
      color={color ? color : "#00222D"}
    />
  );
};
...
export const Cards: React.FC<any> = () => {
  ...
  const [card1, card2, card3, card4] = useLoader(TextureLoader, [
    "./rerun1.png",
    "./rerun2.png",
    "./rerun3.png",
    "./rerun4.png",
    ...
    >
      <Block factor={3.5}>
        <mesh
          position={
            mobile
              ? [-contentMaxWidth + (margin + 1), 4.5, 0]
              : window.innerWidth < 1280
              ? [-contentMaxWidth + (margin + 3), 4.5, 0]
              : window.innerWidth < 1920
              ? [-contentMaxWidth + (margin + 5.5), 4.5, 0]
      ...
      <Block factor={-5.2}>
        <mesh
          position={
            mobile
              ? [contentMaxWidth - (margin + 1), 1, 1]
              : window.innerWidth < 1280
              ? [contentMaxWidth - (margin + 3), 1, 1]
              : window.innerWidth < 1920
              ? [contentMaxWidth - (margin + 5.5), 1, 1]
      ...
      <Block factor={-5.2}>
        <mesh
          position={
            mobile
              ? [-contentMaxWidth + (margin + 1), -4.5, 1]
              : window.innerWidth < 1280
              ? [-contentMaxWidth + (margin + 3), -4.5, 1]
              : window.innerWidth < 1920
              ? [-contentMaxWidth + (margin + 5.5), -4.5, 1]
      ...
      <Block factor={3.4}>
        <mesh
          position={
            mobile
              ? [contentMaxWidth - (margin + 1), -1, 0]
              : window.innerWidth < 1280
              ? [contentMaxWidth - (margin + 3), -1, 0]
              : window.innerWidth < 1920
              ? [contentMaxWidth - (margin + 5.5), -1, 0]
    ...
    <group>
      ...
      >
        <p className="projects__description">
          Local classifieds website with a point system
        </p>
      </Html>
      <Html
        position={
...
export const Filler: React.FC<any> = () => {
  ...
  return (
    <Text
      ref={textRef}
      fontSize={mobile ? 0.5 : window.innerWidth < 1280 ? 1 : 1.75}
      color="#C5C6C7"
      anchorX="center"
      anchorY="middle"
    >
